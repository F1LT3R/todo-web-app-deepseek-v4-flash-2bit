...
class WcTodoCloneButton extends HTMLElement {
  ...
  _attachStyles() {
    ...
    link.rel = 'stylesheet';
    link.href = new URL('wc-todo-clone-button.css', import.meta.url);
...
customElements.define('wc-todo-clone-button', WcTodoCloneButton);

export { WcTodoCloneButton };
